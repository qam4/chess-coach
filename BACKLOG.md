...
**Open actions: 12.** Generated — edit the fields under each heading, not this table.
...
## TOP — The error cause names pieces nobody is attacking (2026-09-21, architecture review D2)

- **Category:** coaching
- **Gives:** 16 of 81 spoken turns (20%). Measured over all five v54 games: **0 of those 16 name
  a square that is actually attacked** after the student's move, and 4 name a square the opponent
